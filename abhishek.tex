...
\emph{Current	} & \textbf{ROR Consultant}\\ \textsc{February 2019} & \emph{\textsc{Fleetpanda}} \\&\footnotesize{Ruby on Rails, Task Scheduling, Marketplace, Schema based multitenancy}\\\multicolumn{2}{c}{} \\
